...
public class CoolantTempSensor
{
    ...
    /// <summary>
    /// Retrieves the TimeSpan representing the refresh period, which is equal to the sample interval of _input.
    /// </summary>
    ...
    /// <summary>
    /// Represents the sensor curve associated with this object.
    /// </summary>
